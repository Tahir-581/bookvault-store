...
-- Book service badges
ALTER TABLE store_books ADD COLUMN IF NOT EXISTS is_kindle_unlimited boolean NOT NULL DEFAULT false;
...
UPDATE store_settings SET value = '{
  "columns": [
    ...
    {"title":"Make Money with Us","links":[{"label":"Sell on BookVault","href":"/pages/help"},{"label":"Associates Programme","href":"/pages/help"},{"label":"Advertise Your Products","href":"/pages/help"},{"label":"Independently Publish with Us","href":"/pages/help"}]},
  ...
  "subsidiaries": [
    ...
    {"label":"Kindle Direct Publishing","description":"Indie Digital & Print Publishing Made Easy","href":"/pages/help"},
  ...
  "copyright": "© 1996-2026, BookVault. All rights reserved."
}'::jsonb
WHERE key = 'footer';
